...
namespace VaroniaBackOffice
{
    public class VaroniaInfoUI_Addon : EditorWindow
    {
        ...
        // Appelés DEPUIS le rendu (OnGUI, DrawPathRow, DrawFooter) : sans cache, chaque repaint
        // allouait ~7 Texture2D en HideAndDontSave, jamais libérées. On mémoïse par paramètres.
        ...
        static readonly System.Collections.Generic.Dictionary<TexKey, Texture2D> _texCache
            = new System.Collections.Generic.Dictionary<TexKey, Texture2D>();
