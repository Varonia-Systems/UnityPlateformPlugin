...
{
    [CustomEditor(typeof(VaroniaPosMul))]
    public class VaroniaPosMulEditor : Editor
    {
        // ── Style cache ───────────────────────────────────────────────────────────
        ...
        public override void OnInspectorGUI()
        {
            ...
            var  script = (VaroniaPosMul)target;
            bool hasCam = script.camTransform != null;
            ...
            GUILayout.Space(12);
            GUILayout.Label("POS MULTIPLIER", headerStyle);
            GUILayout.Space(12);
            ...
            DrawCard(() =>
            {
                ...
                EditorGUILayout.BeginHorizontal();
                GUILayout.Label("Camera Transform", fieldLabelStyle, GUILayout.Width(130));
                EditorGUILayout.PropertyField(serializedObject.FindProperty("camTransform"), GUIContent.none);
                EditorGUILayout.EndHorizontal();

                GUILayout.Space(2);

                EditorGUILayout.BeginHorizontal();
                GUILayout.Label("Coef Multiplier", fieldLabelStyle, GUILayout.Width(130));
                EditorGUILayout.PropertyField(serializedObject.FindProperty("coefMul"), GUIContent.none);
                EditorGUILayout.EndHorizontal();

            }, hasCam ? colAccent : colWarn);

            GUILayout.Space(8);
            GUILayout.Label("Varonia Back Office  ·  VaroniaPosMul", footerStyle);
            GUILayout.Space(8);
